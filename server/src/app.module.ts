...
@Module({
  imports: [
    ...
    ThrottlerModule.forRoot({
      throttlers: [
        { name: 'default', limit: 12000, ttl: 60_000 },
        { name: 'login', limit: 5000, ttl: 900_000 },
        { name: 'register', limit: 3000, ttl: 3_600_000 },
        { name: 'otpSend', limit: 5000, ttl: 3_600_000 },
        { name: 'otpSubmit', limit: 10000, ttl: 600_000 },
        { name: 'passwordReset', limit: 3000, ttl: 3_600_000 },
        { name: 'refresh', limit: 30000, ttl: 60_000 },
        { name: 'cancel', limit: 10000, ttl: 600_000 },
        { name: 'reschedule', limit: 10000, ttl: 600_000 },
        { name: 'paymentIntent', limit: 5000, ttl: 600_000 },
        { name: 'paymentVerify', limit: 10000, ttl: 600_000 },
      ],
    }),
    PrismaModule,
    RealtimeModule,
