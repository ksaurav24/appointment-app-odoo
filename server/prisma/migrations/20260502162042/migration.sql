...
CREATE TABLE "appointment_type_entities" (
    ...
    "bookablePersonId" UUID,
    "bookableResourceId" UUID,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "appointment_reschedules" (
    ...
    "rescheduledByUserId" UUID NOT NULL,
...
CREATE TABLE "appointment_answers" (
    ...
    CONSTRAINT "appointment_answers_pkey" PRIMARY KEY ("appointmentId","questionId")
);
