...
export default function AdminAnalyticsPage() {
  ...
  const [topMetric, setTopMetric] = useState<"bookings" | "revenue">(
    "bookings",
  );
    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <SummaryCard
          ...
          hint={
            d
              ? `${formatNumber(d.users.activeTotal)} active`
              : undefined
          }
        />
        <SummaryCard
        ...
        <SummaryCard
          ...
          hint={
            d ? `All-time ${formatCurrency(d.revenue.allTime, currency)}` : undefined
          }
        />
      </section>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Tabs
              value={topMetric}
              onValueChange={(v) =>
                setTopMetric(v as "bookings" | "revenue")
              }
            >
              <TabsList>
                {TOP_METRICS.map((m) => (
