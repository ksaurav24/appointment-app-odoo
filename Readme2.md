...
>
> **UI in Figma for the Appointment booking webapp:** <https://www.figma.com/design/xvWjTLvygSwZwdYjRSjEms/Appointly?node-id=57-12016&p=f&t=YKN8TJneCVuTUiOe-0>
...
The **Appointment App** (codename **Appointly**) is a unified scheduling platform that supports both **fixed-duration** appointments (doctor consultations, salon visits) and **variable-duration** appointments (turf rentals, meeting rooms) inside the same architecture.
...
| Resource | Link |
|---|---|
| **Figma — UI/UX Designs (Appointly)** | <https://www.figma.com/design/xvWjTLvygSwZwdYjRSjEms/Appointly?node-id=57-12016&p=f&t=YKN8TJneCVuTUiOe-0> |
...
- **UI / UX Design:** Vandana Thawait — [Figma: Appointly](https://www.figma.com/design/xvWjTLvygSwZwdYjRSjEms/Appointly?node-id=57-12016&p=f&t=YKN8TJneCVuTUiOe-0).
