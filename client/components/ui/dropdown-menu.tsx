...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-default items-center gap-2.5 rounded-lg px-3 py-2 text-sm outline-hidden select-none focus:bg-forest-pale focus:text-forest not-data-[variant=destructive]:focus:**:text-forest data-inset:pl-9.5 data-[variant=destructive]:text-coral data-[variant=destructive]:focus:bg-coral-pale data-[variant=destructive]:focus:text-coral data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 data-[variant=destructive]:*:[svg]:text-coral",
        className
      )}
      {...props}
    />
